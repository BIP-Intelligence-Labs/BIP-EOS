"""
bootstrap_engineering_e03.py

Generates:
engineering/specifications/E03-Engineering-Components.md
"""

from pathlib import Path

ROOT = Path.cwd()
OUTPUT = ROOT / "engineering" / "specifications" / "E03-Engineering-Components.md"
OUTPUT.parent.mkdir(parents=True, exist_ok=True)

DOCUMENT = """# E03 — Engineering Components & Boundaries
